...
export default function StudentRegister() {
  ...
  <form onSubmit={handleSubmit}>
    ...
    <div style={styles.inputGroup}>
      ...
      <input type="text" name="id" value={student.id} onChange={handleChange} style={styles.inputField} required />
    </div>

    <div style={styles.inputGroup}>
      <label style={styles.label}>Full Name:</label>
      <input type="text" name="name" value={student.name} onChange={handleChange} style={styles.inputField} required />
    </div>

    <div style={styles.inputGroup}>
      <label style={styles.label}>Email:</label>
      <input type="email" name="email" value={student.email} onChange={handleChange} style={styles.inputField} required />
    </div>

    <div style={styles.inputGroup}>
      <label style={styles.label}>Password:</label>
      <input type="password" name="password" value={student.password} onChange={handleChange} style={styles.inputField} required />
    </div>
...
const styles = {
  registerContainer: {
    ...
    background: "linear-gradient(to bottom right,rgb(17, 36, 88),rgb(32, 7, 55))",
    color: "white",
  },
  formBox: {
    background: "#1e293b",
